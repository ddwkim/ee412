...
\[
\frac{\partial L}{\partial o_j} = 2(o_j - y_j)
\]
Note
\[
\sigma'(z) = \sigma(z)(1 - \sigma(z))
\]
Therefore, the derivative of the output with respect to $z_j$ is
\[
\frac{\partial o_j}{\partial z_j} = o_j(1 - o_j)
\]
Denote the hidden layer output as $h_i$. Then, since $z_j = \sum_{i=1}^{2} w^2_{ij} h_i$,
\[
\frac{\partial z_j}{\partial w^2_{ij}} = h_i
\]
Putting it all together for the second layer weights
\[
\frac{\partial L}{\partial w^2_{ij}} = 2(o_j - y_j) o_j(1 - o_j) h_i
\]
Gradient of the loss with respect to the weights in the first layer $w^1$ is
\[
\frac{\partial L}{\partial w^1_{ij}} = 
\sum_{k=1}^{2} \left( \frac{\partial L}{\partial o_k} \frac{\partial o_k}{\partial h_j} \frac{\partial h_j}{\partial z_j} \frac{\partial z_j}{\partial w^1_{ij}} \right)
\]
\[
...
\]
Since, $z_j = \sum_{i=1}^{2} w^1_{ij} x_i$,
\[
\frac{\partial z_j}{\partial w^1_{ij}} = x_i
\]
Putting it all together for the first layer weights
\[
\frac{\partial L}{\partial w^1_{ij}} = \sum_{k=1}^{2} 2(o_k - y_k) w^2_{ik} o_k(1 - o_k) h_j(1 - h_j) x_i
\]

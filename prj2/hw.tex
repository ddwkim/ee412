...
\begin{enumerate}
    \item [(a)] $\begin{bmatrix} 0.19382266 \\ 0.47224729 \\ 0.8598926 \end{bmatrix}$
    \item [(b)] $7.872983346207418$
    \item [(c)] 
    $A = \begin{bmatrix} 
        0.70423389 & 0.27936833 & -0.31216389 \\
        0.27936833 & 0.24418694 & -0.19707639 \\
        -0.31216389 & -0.19707639 & 0.17859582 
    \end{bmatrix}$
    \item [(d)] $\begin{bmatrix} 0.81649658 \\ 0.40824829 \\ -0.40824829 \end{bmatrix}, 1.0$
    \item [(e)] 
    $A = \begin{bmatrix} 
        0.03756722 & -0.053965 & 0.02116944 \\
        -0.053965 & 0.07752027 & -0.03040973 \\
        0.02116944 & -0.03040973 & 0.01192916 
    \end{bmatrix}$ \\
    eigvec: $\begin{bmatrix} 0.54384383 \\ -0.78122713 \\ 0.30646053 \end{bmatrix}$ \\
    eigval: $0.12701665379258312$
\end{enumerate}
...
\begin{enumerate}
    ...
    \item[(e)]
        ...
        & a & b & c & d & e & f & g & h \\
        \hline
        A & 2/3 & 5/3 & -10/3 & 5/3 & -7/3 & -10/3 & -1/3 & -4/3 \\
        B & -7/3 & 2/3 & 5/3 & 2/3 & -4/3 & -1/3 & -4/3 & -7/3 \\
        C & -1 & -3 & -2 & 0 & -3 & 1 & 2 & 0\\
        \end{array}
        \]
    \item[(f)]

    \(D_C(A,B) = 1 - \frac{26/9}{\sqrt{320/9}\sqrt{164/9}} =  0.887 \) \\
    \(D_C(A,C) = 1 - \frac{4}{\sqrt{320/9}\sqrt{28}} = 0.873 \) \\
    \(D_C(B,C) = 1 - \frac{-2}{\sqrt{164/9}\sqrt{28}} = 1.089 \)
